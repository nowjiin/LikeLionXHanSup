    ...
    var sku_markerInfos = [
        {
            ...
            content: '<h3>경성 마라탕</h3>\
            <div>경성마라탕 정보</div>'
        },
        {
            sku_position: mkpocha,
            content: '<h3>민규형 포차</h3>\
            <div>민규형 포차 정보</div>'
        },
        {
            sku_position: tongtongpig,
            content: '<h3>통통돼지 정보</h3>\
            <div>통통돼지 정보</div>'
        },
        {
            sku_position: hola,
        ...
        },
        {
            ...
            content: '<h3>와와 닭발 정보</h3>\
            <div>와와닭발 정보</div>'
        },
        {
            sku_position: mygreek,
            content: '<h3>마이그릭 정보</h3>\
            <div>마이그릭 정보</div>'
        },
        {
            sku_position: grandmadarak,
            content: '<h3>할머니다락방 정보</h3>\
            <div>할머니다락방 정보</div>'
        },
        {
            sku_position: piglove,
            content: '<h3>퇘사랑 정보</h3>\
            <div>퇘사랑 정보</div>'
        },
        {
            sku_position: songgangru,
            content: '<h3>송강루 정보</h3>\
            <div>송강루 정보</div>'
        },{
            sku_position: skpocha,
            content: '<h3>서경포차 정보</h3>\
            <div>서경포차 정보</div>'
        },
        {
            sku_position: ebari,
            content: '<h3>이 바리 꼴로리 정보</h3>\
            <div>올라 정보</div>'
        }
    ];
